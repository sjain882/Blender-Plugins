...
bl_info = {
    "name": "Import multiple OBJ files with filename",
    "author": "poor, BlueOrange, sjain",
    "version": (1, 0, 0),
    "blender": (2, 79, 0),
    "location": "File > Import-Export",
    "description": "Import multiple OBJ files, UV's, materials while retaining the .obj filename as the object name",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
